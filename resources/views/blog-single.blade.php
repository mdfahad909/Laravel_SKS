      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="{{ route('index') }}">Home</a></span> <span class="mr-2"><a href="{{ route('blog') }}">Blog</a></span> <span>Blog Details</span></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <p>
              <img src="{{ asset('assets/images/image_7.jpg') }}" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="{{ asset('assets/images/image_8.jpg') }}" alt="" class="img-fluid">
            </p>
